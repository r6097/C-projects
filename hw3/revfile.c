 ...
 *
 * Matt Bishop, October 26, 2019
 */
/*
 * PROBLEM (besides the spelling error)
 * Line 79: Tried to free an invalid pointer, p.
 * 
 * To fix it, I changed it to free the specific line it printed, which would be
 * element 'i' of the array of pointers 'line'.
 * 
 */
#include <stdio.h>
#include <stdlib.h>
