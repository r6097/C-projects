...
#include <string.h>
#include <stdlib.h>
#define GENMAX 50   /* max number of generations to run for */
#define GENI 5      /* intervals to print iterations by */
...
int main(int argc, char *argv[])
{
    ...
    lstruct lifebox[totCh];       /* holds data of 1 cell from life pattern */
    lstruct *lifeptr = lifebox;    /* pointer to lifebox */
